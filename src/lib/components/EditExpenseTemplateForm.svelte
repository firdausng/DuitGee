<script lang="ts">
    ...
    let formData: UpdateExpenseTemplate = $state({
        ...
        defaultUserId: template.defaultUserId ?? '__creator__',
    ...
    let category = $state(template.categoryName ?? "");
    ...
    function getDefaultUser() {
        return defaultUser ?? '__creator__';
    }
    ...
    let paymentProvider = $state(template.paymentProvider ?? "");
