<script lang="ts">
    ...
    let categorySearchValue = $state($form.categoryName ?? "");
    ...
    // Payment provider
    let searchPaymentProviderValue = $state($form.paymentProvider || "");
                ...
                >
                    ...
                    <Select.Viewport class="p-1">
                        ...
                        {#each members as member}
                            ...
                            >
                                {#snippet children({ selected })}
                                    {member.firstName} {member.lastName} {member.role === 'owner' ? '(Owner)' : ''}
                                    {#if selected}
                                        <div class="ml-auto">
                                            <Check aria-label="check" />
                                        </div>
                ...
                {#if paymentType?.length > 0}
                    <div>
                        ...
                        <Combobox.Root
                            ...
                            onOpenChangeComplete={(o) => {if (!o) searchPaymentProviderValue = $form.paymentProvider ?? "";}}
                        >
                            <div class="relative">
