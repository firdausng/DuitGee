...
export const expensesApi = new Hono<App.Api>()
    .get(
        ...
        async (c) => {
            ...
            const result = await getExpenses(session.user.id, c.env.DB, {
                page,
                limit,
                categoryId,
                startDate,
    ...
    .post(
        ...
        async (c) => {
            ...
            const expense = await createExpense(session.user.id, {...data, vaultId}, c.env.DB, c.env.KV);
    ...
    .put(
        ...
        async (c) => {
            ...
            const expense = await updateExpense(session.user.id, vaultId, id, data, c.env.DB, c.env.KV);
    ...
    .delete(
        ...
        async (c) => {
            ...
            const isDeleted = await deleteExpense(session.user.id, vaultId, id, c.env.DB, c.env.KV);
    ...
    .get(
        ...
        async (c) => {
            ...
            const result = await getExpensesSummary(session.user.id, c.env.DB, {
                startDate,
                endDate,
                vaultId,
                memberIds
    ...
    .get(
        ...
        async (c) => {
            ...
            const result = await getMemberSpending(session.user.id, c.env.DB, {
                startDate,
                endDate,
                vaultId,
                memberIds
